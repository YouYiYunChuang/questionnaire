...
public enum QuestionnaireExceptionCode implements ErrorCodeI {
    ...
    QUESTIONNAIRE_EXCEPTION_STATUS_DEACTIVATE_EXCEPTION("QUESTIONNAIRE_EXCEPTION_STATUS_DEACTIVATE_EXCEPTION", "问卷已经停用"),

    QUESTIONNAIRE_EXCEPTION_QUESTIONNAIRE_REPEAT_REPORT_EXCEPTION("QUESTIONNAIRE_EXCEPTION_QUESTIONNAIRE_REPEAT_REPORT_EXCEPTION", "用户重复填报次问卷"),

    QUESTIONNAIRE_EXCEPTION_QUESTIONNAIRE_REPEAT_REPORT_CYCLE_EXCEPTION("QUESTIONNAIRE_EXCEPTION_QUESTIONNAIRE_REPEAT_REPORT_CYCLE_EXCEPTION", "问卷周期与上报时间不符"),

    QUESTIONNAIRE_EXCEPTION_QUESTIONNAIRE_REPLICATION_CONTENT_CHECK_EXCEPTION("QUESTIONNAIRE_EXCEPTION_QUESTIONNAIRE_REPEAT_REPORT_CYCLE_EXCEPTION", "问卷周期与上报时间不符"),
    ;
